defmodule MedicaidClaimsCheckerWeb.ConnCase do
  ...
  def register_and_log_in_user(%{conn: conn} = context) do
    user = MedicaidClaimsChecker.AccountsFixtures.user_fixture()
    scope = MedicaidClaimsChecker.Accounts.Scope.for_user(user)
  ...
  def log_in_user(conn, user, opts \\ []) do
    token = MedicaidClaimsChecker.Accounts.generate_user_session_token(user)
  ...
  defp maybe_set_token_authenticated_at(token, authenticated_at) do
    MedicaidClaimsChecker.AccountsFixtures.override_token_authenticated_at(token, authenticated_at)
  end
end
