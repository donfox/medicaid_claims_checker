defmodule MedicaidClaimsCheckerWeb.UserAuth do
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      MedicaidClaimsCheckerWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  @doc """
  Plug for routes that require an admin user.
  """
