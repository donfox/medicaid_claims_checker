defmodule MedicaidClaimsCheckerWeb.UserAuthTest do
  use MedicaidClaimsCheckerWeb.ConnCase, async: true

  alias MedicaidClaimsChecker.Accounts
  alias MedicaidClaimsChecker.Accounts.Scope
  alias MedicaidClaimsCheckerWeb.UserAuth

  import MedicaidClaimsChecker.AccountsFixtures

  @remember_me_cookie "_medicaid_claims_checker_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, MedicaidClaimsCheckerWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
