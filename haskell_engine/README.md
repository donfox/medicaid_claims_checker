...
- [src/Claims/Syntax.hs](../../haskell_engine/src/Claims/Syntax.hs) defines the DSL grammar as algebraic data types (ADTs) — a hallmark FP design.
- [src/Claims/RuleEngine.hs](../../haskell_engine/src/Claims/RuleEngine.hs) and [src/Claims/SimpleEvaluator.hs](../../haskell_engine/src/Claims/SimpleEvaluator.hs) compose rule evaluation functionally, with no mutable state.
- [src/Claims/PolicyCombiner.hs](../../haskell_engine/src/Claims/PolicyCombiner.hs) combines rule results using combinators — a classic FP pattern.
...
File: [src/Claims/RuleEngine.hs](../../haskell_engine/src/Claims/RuleEngine.hs)
...
File: [src/Claims/Syntax.hs](../../haskell_engine/src/Claims/Syntax.hs)
...
File: [src/Claims/SimpleEvaluator.hs](../../haskell_engine/src/Claims/SimpleEvaluator.hs)
...
File: [src/Claims/RuleCache.hs](../../haskell_engine/src/Claims/RuleCache.hs)
