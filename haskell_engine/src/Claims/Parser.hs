...
-- Rules are parsed from text into an abstract syntax tree (AST) defined in "Claims.Syntax".
--
-- == Grammar Overview
--
...
import Claims.Syntax (Action, Binding, FieldRef, Predicate, Rule, SegmentPath, Value)
