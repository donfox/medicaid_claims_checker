defmodule MedicaidClaimsChecker.Accounts.UserToken do
  use Ecto.Schema
  import Ecto.Query
  alias MedicaidClaimsChecker.Accounts.UserToken
  ...
  schema "users_tokens" do
    ...
    belongs_to :user, MedicaidClaimsChecker.Accounts.User
